...
function Learning_Track() {
  const tracks = [
    { percentage: 70, color: "text-blue-500", bg: "bg-blue-500",  label: "HTML" },
    { percentage: 20, color: "text-amber-400", bg: "bg-amber-400", label: "CSS" },
    { percentage: 10, color: "text-green-500", bg: "bg-green-500", label: "JavaScript" }
  ];
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-24 h-24">
        <svg className="w-full h-full -rotate-90">
          ...
          <circle cx="48" cy="48" r="40" stroke="currentColor" strokeWidth="8" fill="transparent" strokeDasharray={circumference} strokeDashoffset={strokeDashoffset} className={`${color} transition-all duration-1000 ease-out`} />
        </svg>
